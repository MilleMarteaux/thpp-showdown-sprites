...
return"https://raw.githubusercontent.com/MilleMarteaux/thpp-showdown-sprites/main/";
}();this.
...
if(_this2.gen<=2&&data.category!=='Status'){
...
var _template59=this.template(_templateId9,_effect14);
...
}else if(blocker==='performance'&&kwArgs.msg){
_templateId10='blockSelf';
}
var _template60=this.template(_templateId10,kwArgs.from);
if(_template60){
...
_template60=this.template(_templateId10,_id18);
return _line25+_template60.replace('[POKEMON]',this.pokemon(_pokemon31));
}
...
_template61=this.template(_pokemon32?_templateId11:'immuneNoPokemon',kwArgs.from);
}
...
var _template64=this.template(_templateId12,_id19);
...
return _template64.replace('[POKEMON]',pokemonName).replace('[ITEM]',_item2).replace('[TRAINER]',this.trainer(_side7));
}
